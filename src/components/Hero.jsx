          ...
          <div className="flex flex-col items-start gap-6 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 lg:gap-4 mt-2 z-10 w-full sm:w-auto">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-3 lg:gap-4 bg-transparent border border-slate-400 text-slate-700 px-6 py-4 lg:px-8 lg:py-5 rounded-none hover:rounded-xl text-lg lg:text-2xl font-semibold hover:bg-slate-100 transition-all duration-300 ease-in-out w-full sm:w-auto"
              >
                Get in Touch
